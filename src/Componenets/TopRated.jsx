...
function TopRated() {
  ...
  const moviesList = topRatedMoviesData?.results || [];
    ...
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="flex items-center justify-center gap-4 py-8">
        ...
        <span className="px-4 py-2 rounded-xl bg-slate-900 border border-slate-800 text-slate-200 text-sm font-bold shadow-inner">
          Page <span className="text-rose-400">{page}</span> of {topRatedMoviesData?.total_pages || 500}
        </span>

        <button
          disabled={loading || (topRatedMoviesData && page >= topRatedMoviesData.total_pages)}
